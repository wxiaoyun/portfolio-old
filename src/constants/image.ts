...
export const NUSCClubLogo: Img = {
	src: "nusc_logo.png",
	alt: "NUS College Club Logo",
	height: 344,
	width: 726,
};

export const VectorPortraitLightMode: Img = {
	src: "/vector_portrait_light.png",
	alt: "Vector Portrait in Light Mode",
};

export const VectorPortraitDarkMode: Img = {
	src: "/vector_portrait_dark.png",
