                ...
                <CardContent>
                  <div className="flex flex-col gap-6">
                    <p className="leading-7">
                      ...
                      comprehensive showcase of my work and expertise in
                    ...
                    <p className="leading-7">
                      ...
                      user interface control, Shadcn UI, a field-tested library
                      of UI components, and Bun as package manager. Animation
                      within the project is gracefully performed by Framer
                      Motion, demonstrating an elegant user interface
                      experience. Finally, it uses Google Analytics to track
